    ...
    >
      <div className="rounded-md backdrop-blur-lg border border-black p-4 w-80 flex flex-col items-center">
        ...
        <div className="text-center mt-4">
          ...
          <h1 className=" text-8xl font-semibold text-red-500 text-opacity-70">
        ...
        <div>
          ...
          <div className=" border border-black p-2 rounded-lg">
            {true ? (
              <div className=" flex flex-col bg-red-500 bg-opacity-30 p-2 rounded-lg mb-2 overflow-y-auto max-h-32">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className=" text-xs">Reported for DUI -2000</p>
                    <h1>Johnzyll Jimeno</h1>
                  </div>
                </div>

                <p className=" w-60 break-words text-xs mt-4">Bad driver!</p>
              </div>
            ) : (
              <p>No reports yet</p>
            )}
            <div>
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)}>
                  ...
                  <Button
                    type="submit"
                    className="w-full mt-2 bg-red-500 bg-opacity-30 "
                  >
                    Submit
                  </Button>
                </form>
